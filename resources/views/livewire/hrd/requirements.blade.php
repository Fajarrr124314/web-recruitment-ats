        ...
        <div class="relative overflow-hidden rounded-3xl p-6 sm:p-8 shadow-xl backdrop-blur-xl border transition-all duration-500 
            ...
            <div class="relative z-10 flex flex-col h-full justify-between gap-6">
                ...
                <div class="flex items-center justify-between mt-4">
                    <span class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-extrabold tracking-wide uppercase shadow-sm
                ...
                @forelse($jobPositions as $job)
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-red-100 flex flex-col justify-between transition-all hover:shadow-md h-fit gap-4">
                        ...
                        <div class="flex items-center justify-between border-t border-slate-50 pt-3">
                            <button wire:click="toggleJobActive({{ $job->id }})" class="text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg border {{ $job->is_active ? 'border-green-200 text-green-600 bg-green-50' : 'border-slate-200 text-slate-500 bg-slate-50' }}">
            ...
            <div class="lg:col-span-2 space-y-4">
                @forelse($requirements as $req)
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-red-100 flex items-center justify-between transition-all hover:shadow-md">
                        ...
                        <div class="flex items-center gap-2">
                            <button wire:click="toggleActive({{ $req->id }})" class="text-xs font-extrabold uppercase tracking-wider px-2.5 py-1 rounded-lg border {{ $req->is_active ? 'border-green-200 text-green-600 bg-green-50' : 'border-slate-200 text-slate-500 bg-slate-50' }}">
